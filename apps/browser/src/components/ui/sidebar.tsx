      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            ...
            <SheetDescription>Side menu bar</SheetDescription>
          </SheetContent>
        </Sheet>
      );
    }
      ...
      >
        ...
        <div
          className={cn(
            ...
            side === 'left'
              ? 'left-0 group-data-[collapsible=offcanvas]:start-[calc(var(--sidebar-width)*-1)]'
              : 'right-0 group-data-[collapsible=offcanvas]:end-[calc(var(--sidebar-width)*-1)]',
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        'flex w-full flex-col overflow-x-auto overflow-y-hidden bg-background',
        'peer-data-[variant=inset]:max-h-[calc(100svh-theme(spacing.4))] md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ms-2 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow',
        className,
      )}
      {...props}
    />
